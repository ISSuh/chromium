...
#ifndef CHROME_BROWSER_UI_WEBUI_LOCAL_MEDIA_UI_H_
#define CHROME_BROWSER_UI_WEBUI_LOCAL_MEDIA_UI_H_
...
class LocalMediaHTMLSource : public content::URLDataSource {
 public:
  // Construct a data source for the specified |source_name|.
  LocalMediaHTMLSource(const std::string& source_name, Profile* profile);
  ~LocalMediaHTMLSource() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(LocalMediaHTMLSource);
};

class LocalMediaHUI : public content::WebUIController {
 public:
...
#endif  // CHROME_BROWSER_UI_WEBUI_LOCAL_MEDIA_UI_H_
